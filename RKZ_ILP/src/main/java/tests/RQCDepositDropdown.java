			...
			//ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+prop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
				...
				{		
			       ...
			       // System.out.println(Password);
			        ...
			        //String ApplicationDate = driver.findElement(By.xpath("//*[@id='appDate']")).getText();
			        //String ApplicationDate = driver.findElement(By.xpath("/html/body/blink/table/tbody/tr/td[4]")).getText()
					 //System.out.println("ApplicationDate is " +ApplicationDate);
					 //test.log(LogStatus.PASS, "Application Date is: " +ApplicationDate);
